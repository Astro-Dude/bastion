# Meta PyTorch × Scaler OpenEnv Hackathon — Round 2 Requirements
...
- Post-training can be done onsite on **25th & 26th** when you receive compute credits for HuggingFace.
...
Each evaluator will judge about 10–15 teams during the judging process, submitting scores individually for each team. Once scores are submitted, the Cerebral Valley team will aggregate scores with other judges to determine the **top 15 finalist projects**.
